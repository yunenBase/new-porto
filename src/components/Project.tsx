    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>Food Delivery App</h2></a>
                <p>Built a Food Delivery App UI using Flutter with dynamic data sourced from an API.</p>
            </div>
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={project2} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="#" target="_blank" rel="noreferrer"><h2>Karamba Warning App</h2></a>
            ...
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={project3} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="#" target="_blank" rel="noreferrer"><h2>Karamba Warning App</h2></a>
            ...
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={project4} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="#" target="_blank" rel="noreferrer"><h2>HOPTIMA</h2></a>
            ...
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>Sleep Monitoring System</h2></a>
